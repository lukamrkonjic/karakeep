...
- [ ] Drag-and-drop a local `.mp4`/`.webm`/`.mkv` file onto the app — confirm it creates a bookmark (not "Unsupported asset type") and the video plays in the feed and the preview modal
