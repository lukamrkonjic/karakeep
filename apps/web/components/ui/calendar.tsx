  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:ring-ring/50 has-focus:ring-[3px] relative rounded-md bg-muted",
